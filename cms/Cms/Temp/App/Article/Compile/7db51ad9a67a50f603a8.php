...
if($_index_c>=$_total_c):$hd["list"]["c"]["last"]=true;endif;?>
 						...
 						<option value='<?php echo $c['cid'];?>' <?php if($field['catid']==$c['cid']){?>selected=''<?php }?>><?php echo $c['_name'];?></option>
...
echo "";
 				...
 				<tr>
 					<th class='w100'>缩略图</th>
 						...
 						<?php if($field['thumb']){?>
							<img src='http://127.0.0.1/v5/cms/<?php echo $field['thumb'];?>' class='w100 h50'/>
						<?php }?>
 					</td>
 				</tr>
 				<tr>
        ...
        $(function(){
                ...
                imageUrl:'http://127.0.0.1/v5/cms/index.php?a=Article&c=Article&id=1&m=ueditor_upload&g=App&water=1&uploadsize=2000000&maximagewidth=false&maximageheight=false'//处理上传脚本
                ,zIndex : 0
 		...
 		<div id="ext">
	 		<table class='table1'>
	 				...
	 				<tr>
	 					<th >栏目描述</th>
	 					<td >
							<textarea class='w300 h100' name='description'>
	 				...
	 				<tr>
	 					<th >点击次数</th>
	 					<td >
	 					<input type='text' name='click' class='w300' value='<?php echo $field['click'];?>'/>
	 					</td>
	 				</tr>
	 				<tr>
	 					<th >来源</th>
	 				...
	 				<tr>
	 					<th >更新时间</th>
	 					<td >
	 					<input type="text" readonly="readonly" id="updatetime" name="updatetime" value="<?php echo date('Y/m/d h:i:s',$field['updatetime']);?>" class="w150"/>
							<script>
