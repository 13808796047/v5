...
<li class="first-item">
     <a href="http://127.0.0.1/v5/cms" class="home"><span>首页</span></a>
</li>
<li class="first-item">
     <a href="http://127.0.0.1/v5/cms/index.php/Index/Index&m=article&cid=3&id=9" class="home"><span>公司简介</span></a>
</li>

<channel type='top'>
                <li >
                	<a href="<?php echo $field['url'];?>" target="_self">
                	<span><?php echo $field['cname'];?></span></a>                                
                </li>
</channel>
              <li class="first-item">
     <a href="http://www.houdunwang.com" target="_blank"><span>后盾网</span></a>
</li>                  
                </ul></div>	
		</div>
	</div>      
